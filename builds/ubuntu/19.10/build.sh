...
if [ -z "${1}" ]; then
  ...
  mkdir -p ./scripts/os
  cp $HOME/scripts/os/ubuntu-19.10.sh ./scripts/os/
  ...
  $HOME/scripts/fac/singularity/build_container.sh ubuntu19 

else

  $HOME/scripts/fac/singularity/build_container_remote.sh ${1} ubuntu19
