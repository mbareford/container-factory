...
LD_LIBRARY_PATH=${FFTW_ROOT}/lib:${MKL_ROOT}/lib/intel64_lin:${MPI_ROOT}/lib:${MPI_ROOT}/lib/release:${MPI_ROOT}/libfabric/lib:/lib/x86_64-linux-gnu/libibverbs-cirrus:/lib/x86_64-linux-gnu:/.singularity.d/libs
